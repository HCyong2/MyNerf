...
def train():
    ...
    # Summary writers
    # writer = SummaryWriter(log_dir='./logs/test04')
    ...
    for i in trange(start, N_iters):
        ...
        if i % 100 == 0:
            ...
            for img_i in i_test:
                ...
                test_psnr += psnr.item()
            test_loss /= len(i_test)
            test_psnr /= len(i_test)

            writer.add_scalar('Loss/test', test_loss, i)
            writer.add_scalar('PSNR/test', test_psnr, i)
            print(f"Iteration {i}: Avg Test Loss: {test_loss}, Avg Test PSNR: {test_psnr}")
